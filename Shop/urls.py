...
from Shop.views import CategorySearch, cart_add, payout, payout2, payout3, cart_clear, cart_detail, item_clear, item_decrement, item_increment, search, main_product, api_check, CategorySearch
